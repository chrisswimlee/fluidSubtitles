                        ...
                        if self.accessibilityEnabled {
                            VStack(alignment: .leading, spacing: 12) {
                                ...
                                VStack(alignment: .leading, spacing: 8) {
                                    ...
                                    Text("Listening starts from the Translate page. A keyboard shortcut is optional.")
                                        .font(.caption)
                                ...
                                VStack(spacing: 12) {
                                    ...
                                    self.optionToggleRow(
                                        ...
                                        description: "This release does not send analytics. The toggle only applies if a future build includes an analytics endpoint. " +
                                            "Never includes transcription text, audio, or prompts.",
                            ...
                            VStack(alignment: .leading, spacing: 12) {
                                HStack(spacing: 10) {
                                    ...
                                    VStack(alignment: .leading, spacing: 2) {
                                        ...
                                        Text("Needed to type a translation into another app from Theater or the translate shortcut.")
                                            .font(self.theme.typography.bodySmall)
                                            .foregroundStyle(self.settingsSecondaryText)
                                    }
                                    Spacer()
...
private extension SettingsView {
    func prepareSelectedSection() async {
        ...
        case .notifications, .overlay, .dataAndDiagnostics, .experimental, .translation:
            break
        }
    }
...
struct AnalyticsConfirmationView: View {
    ...
    private var contactInfoText: AttributedString {
        AttributedString(
            "If you have concerns, review Settings → What we collect. \(FluidProduct.displayName) does not send analytics in this release."
        )
    }
