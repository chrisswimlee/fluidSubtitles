...
struct ChangelogView: View {
        ...
        ThemedCard(style: .standard, hoverEffect: false) {
            VStack(alignment: .leading, spacing: self.theme.metrics.spacing.sm) {
                Text("No changelog available")
                    ...
                    .foregroundStyle(self.theme.palette.primaryText)
                Text(FluidProduct.updateRepository == nil
                    ? "\(FluidProduct.displayName) does not publish release notes yet."
                    : "\(FluidProduct.displayName) could not load GitHub release notes right now.")
    ...
    private var cacheKey: String {
        ...
        return "fluidSubtitlesChangelogCache.\(channel)"
    }
}
    ...
    struct Model: Hashable {
        ...
        private static func isBoilerplateLine(_ line: String) -> Bool {
            ...
            return lowercased.contains("report issues:") ||
                ...
                lowercased.contains("github.com/chrisswimlee/fluidsubtitles/issues")
        }
    }
