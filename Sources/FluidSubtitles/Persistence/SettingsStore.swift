...
final class SettingsStore: ObservableObject {
    ...
    var translationTargetLanguageID: String {
        get {
            ...
            if let stored, let language = TranslationLanguageCatalog.language(id: stored), language.id != sourceID {
                return language.id
            }
        ...
        set {
            objectWillChange.send()
            let sourceID = self.translationSourceLanguageID
            let resolved = TranslationLanguageCatalog.language(id: newValue)
            let id = (resolved?.id != sourceID ? resolved?.id : nil)
    ...
    /// Optional LM Studio polish on finished lines only. Never used on the live caption path.
    var llmTranslationPolishEnabled: Bool {
        get { self.defaults.bool(forKey: Keys.llmTranslationPolishEnabled) }
        set {
            objectWillChange.send()
            self.defaults.set(newValue, forKey: Keys.llmTranslationPolishEnabled)
        }
    }

    /// Local MLX runner for finished Korean / English / Thai captions.
    var mlxRunnerEnabled: Bool {
        get { self.defaults.bool(forKey: Keys.mlxRunnerEnabled) }
        set {
            objectWillChange.send()
            self.defaults.set(newValue, forKey: Keys.mlxRunnerEnabled)
        }
    }

    var mlxRunnerModelID: String {
        get { MLXRunnerCatalog.resolvedModelID(self.defaults.string(forKey: Keys.mlxRunnerModelID) ?? "") }
        set {
            objectWillChange.send()
            self.defaults.set(MLXRunnerCatalog.resolvedModelID(newValue), forKey: Keys.mlxRunnerModelID)
        }
    }
    ...
    var mlxRunnerPort: Int {
        get {
            let value = self.defaults.object(forKey: Keys.mlxRunnerPort) as? Int ?? MLXRunnerCatalog.defaultPort
...
private extension SettingsStore {
    ...
    enum Keys {
        ...
        static let liveTranslationEnabled = "LiveTranslationEnabled"
        ...
        static let llmTranslationPolishEnabled = "LLMTranslationPolishEnabled"
        static let mlxRunnerEnabled = "MLXRunnerEnabled"
        static let mlxRunnerModelID = "MLXRunnerModelID"
        static let mlxRunnerPort = "MLXRunnerPort"
