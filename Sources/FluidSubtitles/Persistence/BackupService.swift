...
enum BackupServiceError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .invalidJSON:
            return "The selected backup file is not a valid \(FluidProduct.displayName) backup."
        }
    }
}
...
final class BackupService {
    ...
    func makeBackupDocument() async throws -> AppBackupDocument {
        ...
        return AppBackupDocument(
            ...
            transcriptionHistory: try await TranscriptionHistoryStore.shared.makeBackupPayload(),
    ...
    func suggestedFilename(for date: Date = Date()) -> String {
        ...
        return "fluidSubtitles_Backup_\(formatter.string(from: date)).json"
    }
