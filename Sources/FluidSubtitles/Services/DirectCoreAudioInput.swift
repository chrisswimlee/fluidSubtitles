...
private final nonisolated class DirectCoreAudioInput: DirectCoreAudioInputControlling, @unchecked Sendable {
    ...
    private let workerQueue = DispatchQueue(
        label: "com.fluidsubtitles.audio.direct-input-consumer",
        qos: .userInteractive
    )
...
final nonisolated class DirectCoreAudioLifecycleController: @unchecked Sendable {
    ...
    private let lifecycleQueue = DispatchQueue(
        label: "com.fluidsubtitles.audio.direct-lifecycle",
        qos: .userInitiated
    )
    private let listenerQueue = DispatchQueue(
        label: "com.fluidsubtitles.audio.direct-format-listeners",
        qos: .userInitiated
    )
