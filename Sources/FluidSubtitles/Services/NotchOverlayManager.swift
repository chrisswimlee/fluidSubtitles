...
final class NotchOverlayManager {
    ...
    func switchLiveOverlayMode(to _: SettingsStore.PromptMode) {
    ...
    private func syncPromptPickerMode(for _: OverlayMode) {
        NotchContentState.shared.promptPickerMode = .dictate
    }

    private func normalizedOverlayMode(_: OverlayMode) -> OverlayMode {
        .dictation
    }
    ...
    private var enableNotchFeatures: Bool {
        SettingsStore.shared.overlayPosition == .top
    }
